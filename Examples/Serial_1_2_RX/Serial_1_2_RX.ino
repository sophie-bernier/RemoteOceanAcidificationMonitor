...
static String serial1RxBuf;
static String serial2RxBuf;
...
void loop() {
  ...
  // Echo Serial1 and Serial2 to Serial
  if (Serial1.available())
  {
    serial1RxBuf = Serial1.readStringUntil('\n');
    Serial.print("Received from Serial1: ");
    Serial.println(serial1RxBuf);
  }
  if (Serial2.available())
  {
    serial2RxBuf = Serial2.readStringUntil('\n');
    Serial.print("Received from Serial2: ");
    Serial.println(serial2RxBuf);
  }
}
